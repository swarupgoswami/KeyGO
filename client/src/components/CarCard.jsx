  ...
  return (
    <div onClick={()=>{navigate(`/car-details/${car._id}`);scrollTo(0,0)}} className='group rounded-xl overflow-hidden  shadow-lg hover:translate-y-1 transition-all duration-500 cursor-pointer'>
        ...
        <div className="relative h-48 overflow-hidden">
           ...
           {car.isAvailable && <p className='absolute top-4 left-4 bg-primary/90 text-white text-xs px-2.5 py-1 rounded-full'>Available no</p>}
        ...
        <div className="p-4 sm:p-5">
          ...
          <div className="mt-4 grid grid-cols gap-y-2 text-gray-600">
            ...
            <div className="flex items-center text-sm text-muted-foreground">
              <img src={assets.users_icon} alt="user_icon" />
              <span>{car.seating_capacity}</span>
            </div>

            <div className="flex items-center text-sm text-muted-foreground">
              <img src={assets.fuel_icon} alt="fuel_icon" />
              <span>{car.fuel_type}</span>
            </div>

            <div className="flex items-center text-sm text-muted-foreground">
              <img src={assets.car_icon} alt="fuel_icon" />
              <span>{car.transmission}</span>   
            </div>

            <div className="flex items-center text-sm text-muted-foreground">
              <img src={assets.location_icon} alt="fuel_icon" />
