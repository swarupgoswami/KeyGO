  ...
  return (
    <div className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
        ...
        <div className="text-white">
            ...
            <p className='mt-2 font-medium'>Monetize your vechile effortlessly by listing it on KeyGO</p>
            ...
            <button className='px-6 py-2 bg-white hover:bg-slate-100 hover:translate-y-1 transition-all text-primary rounded-lg text-sm mt-4 cursor-pointer'>List your car</button>
        </div>
